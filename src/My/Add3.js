...
function Admin(){
  ...
  function Saveproduct(e) {
    ...
    console.log(data);
    axios.post("http://16.171.172.126:3306/addmessage", data).then(
              ...
              <div class="card mb-10">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="message" class="form-control" id="exampleInputmessage" aria-describedby="planMessage" onChange={handelDemo2} placeholder="Enter Inspirational Message" style={{height: "calc(1.5em + 0.75rem + 1px)!important;"}}/>
                      </div>
