...
function Admin() {
  ...
  useEffect(() => {
    axios.get("http://16.171.153.71:3306/subscription").then(res => setProducts(res.data));
  }, []);
  ...
  function Piya(e) {
    ...
    axios.get(`http://16.171.153.71:3306/subdelete/${id}`).then(
  ...
  function onEdit(e) {
    const id = e.target.id;
    axios.get(`http://16.171.153.71:3306/subedit/${id}`).then(
      res => {
        var diojk = res.data
