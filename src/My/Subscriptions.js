...
function Admin() {
  ...
  useEffect(() => {
    axios.get("http://16.171.172.126:3306/subscription").then(res => setProducts(res.data));
  }, []);
  ...
  function Piya(e) {
    ...
    axios.get(`http://16.171.172.126:3306/subdelete/${id}`).then(
  ...
  function onEdit(e) {
    const id = e.target.id;
    axios.get(`http://16.171.172.126:3306/subedit/${id}`).then(
      res => {
        var diojk = res.data
        navigate('/Editsub', { state: diojk })
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          <div id="content">
            ...
            <div class="container-fluid" id="container-wrapper">
              ...
              <div class="card-body" style={{ marginLeft: "0", paddingLeft: "0" }} align="right">

                <a href="add"><button type="button" class="btn btn-outline-primary mb-1">ADD</button></a>
                      ...
                      <table class="table align-items-center table-flush">
                        <thead class="thead-light" >
                          <tr>
                            ...
                            <th width="14%" style={{ color: "black" }}>Subscription Plan</th>

                            <th width="13%">Subscribed Users</th>
                            <th width="15%"> Free Trial</th>
                            <th width="10%"> Subscription Price</th>
                            <th width="6%">Set Up</th>
                          ...
                          {product.map((item, index) => {
                            return (
                              <tr key={index}>
                                ...
                                <td> {item.status}</td>
                                <td><a><i class="fa fa-edit" id={item.id} onClick={onEdit}></i></a></td>
