              ...
              <div class="card mb-10">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="category" class="form-control" id="exampleInputcategory" aria-describedby="planCategory" placeholder="Enter Category name"/>
                      </div>
                       <div class="form-group">
                      <label for="exampleInputSubCategory">Sub Category Name</label>
                      <input type="user" class="form-control" id="exampleInputsubcategory" aria-describedby="planSubCategory" placeholder="Enter Sub Category name"/>
                      </div>
