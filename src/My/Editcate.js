...
function handelDemo8(e) {
  ...
  function Saveproduct(e) {
    ...
    axios.post("http://16.171.172.126:3306/updatecate", formData, config).then(
        res => console.log(res)
...
useEffect(() => {
    ...
    setName(location.state[0].catename)
              ...
              <div class="card mb-10">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="category" class="form-control" id="exampleInputcategory" aria-describedby="planCategory" placeholder="Enter Category name" onChange={handelDemo1} value={name}/>
                      </div>
                      <div class="form-group">
