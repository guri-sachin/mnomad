...
function Admin(){
  ...
  useEffect(()=>{
    axios.get("http://16.171.172.126:3306/listticket").then(res=>setProducts(res.data));
},[]);
  ...
  var data=  {"reply":reply,"id":id}
   ...
   axios.post("http://16.171.172.126:3306/reply",data).then(
         res=>  
      ...
      console.log(data)
        ...
        function Piya(e){
          ...
          axios.get(`http://16.171.172.126:3306/ticketdelete/${id}`).then(
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">Ticket Raised</li>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Ticket Raised</h6>
                </div>
                 ...
                 return(
                     <tr key={index}>
                       <td>{item.msg}</td>
                        ...
                        <td>{item.email}</td>
                        <td> {item.phone} </td>
                        <td><a href="" id={item.id} onClick={Piya}><i class="fa fa-trash"  id={item.id} onClick={Piya}></i></a></td>
                        <td> 
     <button type="button" class="btn btn-primary mb-1" data-toggle="modal" data-target="#exampleModalLong1"
                    id="#modalLong1" onClick={handelDemo1} value={item.id}> Reply</button>  </td>
                       <td>
                      {item.reply.length !== 0 ? 
                        <div class="ring-container">
    <div class="ringring"></div>
    <div class="circle"></div>
</div>  :            <div class="ring-container1">
              ...
              <div class="card mb-10">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                     <label for="exampleInputDate">Reply</label>
                      <input type="text" class="form-control" id="exampleInputReply" aria-describedby="planReply" placeholder="Reply" style={{height: "calc(1.5em + 4rem + 1px)!important;"}} onChange={handelDemo}/>
                      </div>
                    ...
                    <button type="submit" class="btn btn-primary" onClick={handelDemo13}>Submit</button>
                  </form>
                </div>
              </div>
