...
function Admin(){
  ...
  useEffect(()=>{
    axios.get("http://16.171.153.71:3306/listticket").then(res=>setProducts(res.data));
},[]);
  ...
  var data=  {"reply":reply,"id":id}
   ...
   axios.post("http://16.171.153.71:3306/reply",data).then(
         res=>  
      ...
      console.log(data)
        ...
        function Piya(e){
          ...
          axios.get(`http://16.171.153.71:3306/ticketdelete/${id}`).then(
