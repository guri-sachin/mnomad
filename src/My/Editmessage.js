...
function Admin(){
  ...
  function Saveproduct(e) {
    ...
    var data = { "id":id,"msg": msg ,"time": time };

    console.log(data);
    axios.post("http://16.171.172.126:3306/updatemessage", data).then(
    ...
    Swal.fire({
        ...
        text: "message added successfuly",
    })
...
useEffect(() => {
    ...
    setMsg(location.state[0].msg)
    setTime(location.state[0].time)
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Inspirational Message</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item">Inspirational Message</li>
              ...
              <div class="card mb-10">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      <label for="exampleInputCategory">Message</label>
                      <input type="message" class="form-control" id="exampleInputmessage" aria-describedby="planMessage" onChange={handelDemo2} placeholder="Enter Inspirational Message" style={{height: "calc(1.5em + 0.75rem + 1px)!important;"}} value={msg}/>
                      </div>
                      
                      
                      <div class="form-group">
                      <label for="exampleInputTime">Select a time</label>
                      <input type="time" id="appt" name="appt"  class="form-control"  onChange={handelDemo6} style={{height: "calc(1.5em + 0.75rem + 1px)!important;"}}/>
                      </div>
          ...
          <div class="card-body"  align="right">
                  ...
                  <a href="message"><button type="button" class="btn btn-outline-primary mb-1">Back</button></a>
