...
function Admin(){
  ...
  function Saveproduct(e) {
    ...
    axios.post("http://16.171.172.126:3306/addvideo", formData, config).then(
        res => console.log(res)
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Dance Videos</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
             
               <li class="breadcrumb-item">Dance Videos</li>
                ...
                <div class="card-body">
                  ...
                  <label for="exampleInputUser">File Upload</label>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile"  name="filename" placeholder="enter product price" accept="video/*"  onChange={(e) => { setVideo(e.target.files) }} multiple/>
                    ...
                    <div class="form-group">
                      ...
                      <input type="message" class="form-control" id="exampleInputmessage" aria-describedby="planMessage" onChange={handelDemo2} placeholder="Enter title" style={{height: "calc(1.5em + 0.75rem + 1px)!important;"}}/>
                      </div>
          ...
          <div class="card-body"  align="right">
                  ...
                  <a href="video"><button type="button" class="btn btn-outline-primary mb-1">Back</button></a>
