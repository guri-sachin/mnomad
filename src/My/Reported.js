...
function Admin(){
  ...
  const [product,setProducts] =useState([]);
   useEffect(()=>{
    axios.get("http://16.171.172.126:3306/reported").then(res=>setProducts(res.data));
},[product]);
 ...
 function Piya(e){
  ...
  axios.get(`http://16.171.172.126:3306/noia/${id}`).then(
                ...
                <div class="table-responsive">
                 ...
                 return(
                     <tr key={index}>
                        ...
                        <td><a id={item.id} onClick={Piya} ><i id={item.id} onClick={Piya} class="fa fa-trash"></i></a></td>
                        </tr>
                 );
             })}
