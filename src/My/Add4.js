...
function Admin(){
  ...
  function Subs(e) {
    ...
    var data = { "gname":groupname ,"gnumb":groupno };
  
    console.log(data);
    axios.post("http://16.171.172.126:3306/social", data).then(
    ...
    Swal.fire({
      ...
      text: "groups added successfuly",
  })
  
  };
  function handelDemo11(e) {
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Social Media Groups</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item">Social Media Groups</li>
              ...
              <div class="card mb-10">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      <label for="exampleInputCategory">Group Name</label>
                      <input type="name" class="form-control" id="exampleInputName" aria-describedby="planName" placeholder="Enter Group name" style={{height: "calc(1.5em + 0.75rem + 1px)!important;"}}  onChange={handelDemo11}/>
                      </div>
                       <div class="form-group">
                      <label for="exampleInputSubCategory">Users</label>
                      
                      <input type="name" class="form-control" id="exampleInputName" aria-describedby="planName" placeholder="Enter No of mamebers" style={{height: "calc(1.5em + 0.75rem + 1px)!important;"}}  onChange={handelDemo12}/>
                    ...
                    <button type="submit" class="btn btn-primary" onClick={Subs}>Submit</button>
                  </form>
                </div>
              </div>
          ...
          <div class="card-body"  align="right">
                  ...
                  <a href="social"><button type="button" class="btn btn-outline-primary mb-1">Back</button></a>
