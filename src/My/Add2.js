...
function Saveproduct(e) {
  ...
  axios.post("http://16.171.172.126:3306/Savesubcate", formData, config).then(
      res => console.log(res)
                   ...
                   <option key={index} value={products.catename} onChange={handelDemo13}>{products.catename}</option>
                    ...
                    <option>Room1</option>
                     <option>Room2</option>
                      ...
                      <input type="user" class="form-control" id="exampleInputsubcategory" aria-describedby="planSubCategory" placeholder="Enter Sub Category name" style={{height: "calc(1.5em + 0.75rem + 1px)!important;"}} onChange={handelDemo1}/>
                      </div>
