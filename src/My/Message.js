...
function Admin(){
  ...
  const navigate = useNavigate();
   useEffect(()=>{
    axios.get("http://16.171.172.126:3306/listmessage").then(res=>setProducts(res.data));
},[]);
 ...
 function Piya(e){
  ...
  axios.get(`http://16.171.172.126:3306/messagedelete/${id}`).then(
...
function onEdit(e){
  const id = e.target.id;
  axios.get(`http://16.171.172.126:3306/messageedit/${id}`).then(
      res =>{
     var diojk =res.data 
    navigate('/Editmessage', { state: diojk})
...
<div class="card-body"  align="right">
                  ...
                  <a href="add3"><button type="button" class="btn btn-outline-primary mb-1">ADD</button></a>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Inspirational Message</h6>
                </div>
