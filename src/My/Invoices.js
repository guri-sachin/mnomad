...
function Admin(){
  ...
  var kl = Number(location.state[0].price *location.state[0].member) + 59
  console.log(location.state[0].date)

  function Saveproduct(e) {
  var data = {"id":location.state[0].id, "member": location.state[0].member ,"price": location.state[0].price,"email":location.state[0].email,"total":kl};

  console.log(data);
  axios.post("http://16.171.172.126:3306/hhhjjkkk", data).then(
...
return(
 <div  >
                            ...
                            <div class="tab-content">
                              ...
                              <tr>
                                                  ...
                                                  <td class="text-center">{location.state[0].id}</td>
                                                                    ...
                                                                    <td class="text-end">   {location.state[0].member*location.state[0].price}  </td>
                                                                    </tr>
  ...
  <tr>
                                ...
                                <button type="button" class="btn btn-primary btn-lg my-1" onClick={Saveproduct}><i class="fa fa-paper-plane-o" onClick={Saveproduct}></i>Send</button>
                                &nbsp;
