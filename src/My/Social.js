...
function Admin(){
  ...
  useEffect(()=>{
    axios.get("http://16.171.172.126:3306/listgroups").then(res=>setProducts(res.data));
...
var gname =(e.target.value)
  ...
  const response = await fetch("http://16.171.172.126:3306/listsocial",config);
  ...
  navigate('/Participants',{state:data1}) 
};
...
<div class="card-body"  align="right">
                  ...
                  <a href="add4" ><button type="button" class="btn btn-outline-primary mb-1" >ADD</button></a>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Social Media Groups</h6>
                </div>
                <div class="table-responsive">
                 ...
                 return(
                     <tr key={index}>
                        <td>{item.gname}</td> 
                        <td><button type="button" onClick={Subs} value={item.gname} class="btn btn-outline-primary mb-1">Participants</button></td>                      
