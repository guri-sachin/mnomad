...
function Admin(){
  ...
  useEffect(()=>{
    axios.get("http://16.171.172.126:3306/listvideosk").then(res=>setProducts(res.data));
},[]);
...
function Piya(e){
  ...
  axios.get(`http://16.171.172.126:3306/videodelete/${id}`).then(
...
<div class="card-body"  align="right">
                  ...
                  <a href="add5"><button type="button" class="btn btn-outline-primary mb-1">ADD IN ROOM 3</button></a>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Dance Videos</h6>
                </div>
                <div class="table-responsive">
                  <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                      <tr>
                        <th>Dance Videos in Room 3</th>
                 ...
                 return(
                     <tr key={index}>
                        <td>{<video controls style={{height:"100px",width:"100px"}}>

<source src={item.dvideos} type="video/mp4" />
