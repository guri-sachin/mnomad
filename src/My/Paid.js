...
function Admin(){
  ...
  const[type,setType]= useState();
   ...
   useEffect(()=>{
    axios.post("http://16.171.172.126:3306/paiduser").then(res=>setProducts(res.data));
},[]);
 ...
 console.log(e.target.value)
  ...
  const response = await fetch("http://16.171.172.126:3306/stype",config);
  ...
  if(e.target.value === "audio"){
    navigate('/audio',{state:data1})
   }else if(e.target.value === "live"){
    navigate('/sessions',{state:data1})
   }
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Paid Users</li>
            </ol>
          </div>
<div class="card-body">
                  
                  <a ><button type="button" class="btn btn-outline-primary mb-1" value={"audio"} onClick={Subs}>AUDIO SAVE</button></a> &nbsp; 
                  <a ><button type="button" class="btn btn-outline-secondary mb-1"  value={"live"} onClick={Subs}>LIVE SESSIONS</button></a>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Paid Users</h6>
                </div>
