...
function Admin(){
  ...
  useEffect(()=>{
    ...
    axios.post("http://16.171.172.126:3306/listcorpratear", data).then(
      res =>
      setProducts(res.data)


    )
    // axios.get("http://16.171.172.126:3306/listcorpratein").then(res=>setProducts(res.data));
},[product]);
...
console.log(e.target.name)
  ...
  axios.post(`http://16.171.172.126:3306/coreupdate/${id}`,data).then(
    res=> console.log(res))
    console.log(id);
  console.log(data);
  Swal.fire({
...
{/* <div class="card-body" align="right">
                  ...
                  <a href="viewinvoice.html"><button type="button" class="btn btn-outline-primary mb-1">VIEW INVOICE</button></a>
                  &nbsp; 
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Corporate Users</h6>
                </div>
...
<td>{item.member}</td>
                                                                           <td>{item.Rid}</td>
                        <td>    <button type="button" class="btn btn-outline-primary mb-1"  name={"Active"} onClick={Show3}  id={item.id}  >Undo</button></td> 
</tr> 
                 );
             })}
