...
function Admin(){
  ...
  useEffect(()=>{
    ...
    axios.post("http://16.171.153.71:3306/listcorpratear", data).then(
      res =>
      setProducts(res.data)


    )
    // axios.get("http://16.171.153.71:3306/listcorpratein").then(res=>setProducts(res.data));
},[product]);
...
console.log(e.target.name)
  ...
  axios.post(`http://16.171.153.71:3306/coreupdate/${id}`,data).then(
    res=> console.log(res))
    console.log(id);
  console.log(data);
  Swal.fire({
