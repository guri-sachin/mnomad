...
console.log(e.target.value)
   ...
   useEffect(()=>{
    axios.get("http://16.171.172.126:3306/listcate").then(res=>setProducts(res.data));
},[product]);
...
console.log(e.target.name)
  ...
  axios.post(`http://16.171.172.126:3306/cateupdate/${id}`,data).then(
    res=> console.log(res))
    console.log(id);
  console.log(data);
  Swal.fire({
 ...
 function Piya(e){
  ...
  axios.get(`http://16.171.172.126:3306/catedelete/${id}`).then(
...
function onEdit(e){
  const id = e.target.id;
  axios.get(`http://16.171.172.126:3306/cateedit/${id}`).then(
      res =>{
     var diojk =res.data 
    navigate('/Editcate', { state: diojk})
...
<div class="card-body"  align="right">
                  ...
                  <a href="add1"><button type="button" class="btn btn-outline-primary mb-1">ADD</button></a>
