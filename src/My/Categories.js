...
console.log(e.target.name)
  ...
  axios.post(`http://16.171.153.71:3306/cateupdate/${id}`,data).then(
    res=> console.log(res))
    console.log(id);
  console.log(data);
  Swal.fire({
 ...
 function Piya(e){
  ...
  axios.get(`http://16.171.153.71:3306/catedelete/${id}`).then(
...
function onEdit(e){
  const id = e.target.id;
  axios.get(`http://16.171.153.71:3306/cateedit/${id}`).then(
      res =>{
     var diojk =res.data 
