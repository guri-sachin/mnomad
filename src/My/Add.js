...
function Admin(){
  ...
  function Saveproduct(e) {
    var data = {"plan":plan,"suser":suser,"trial":trial,"subprice":subprice,"up":up,"status":status};
    console.log(data);
    
    axios.post("http://16.171.172.126:3306/addsubscriptions",data).then(
        res=> console.log(res)
              ...
              <div class="card mb-10">
                ...
                <div class="card-body">
                  <form onSubmit={(event) => event.preventDefault()}>
                      ...
                      <input type="plan" class="form-control" id="exampleInputPlan" aria-describedby="planlHelp" placeholder="Enter plan" onChange={handelDemo2}/>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="" class="form-control" id="exampleInputPrice" aria-describedby="pricelHelp" placeholder="Enter price" onChange={handelDemo5}/>
