...
function Admin(){
  ...
  const [product,setProducts] =useState([]);
   useEffect(()=>{
    axios.post("http://16.171.153.71:3306/register").then(res=>setProducts(res.data));
},[]);
 ...
 function Piya(e){
  ...
  axios.get(`http://16.171.153.71:3306/redelete/${id}`).then(
...
async function Details(e){
  ...
  console.log(e.target.id)
   ...
   const response = await fetch("http://16.171.153.71:3306/listdetails",config);
