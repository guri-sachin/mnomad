...
function Admin(){
  ...
  const [product2,setProducts2] =useState([]);
   ...
   useEffect(()=>{
    axios.post("http://16.171.172.126:3306/subscribed").then(res=>setProducts(res.data));
},[]);
 ...
 console.log(e.target.value)
  ...
  const response = await fetch("http://16.171.172.126:3306/subtype",config);
  ...
  if(e.target.value === "room1"){
    navigate('/room1',{state:data1})
   }else if(e.target.value === "room2"){
    navigate('/room2',{state:data1})
   }else if(e.target.value === "room3"){
    navigate('/room3',{state:data1})
   }else if(e.target.value === "live"){
    navigate('/live',{state:data1})
   }else if(e.target.value === "corporate"){
    navigate('/corporate',{state:data1})
   }
...
<div class="card-body">
                  ...
                  <a ><button type="button" class="btn btn-outline-primary mb-1"  value={"room1"} onClick={Subs}>ROOM 1</button></a>  &nbsp; 
                  <a ><button type="button" class="btn btn-outline-secondary mb-1"  value={"room2"} onClick={Subs}>ROOM 2</button></a>  &nbsp; 
                   <a ><button type="button" class="btn btn-outline-success mb-1"  value={"room3"} onClick={Subs}>ROOM 3</button></a>  &nbsp; 
                  <a ><button type="button" class="btn btn-outline-danger mb-1"  value={"live"} onClick={Subs}>LIVE SESSIONS</button></a>  &nbsp; 
                  <a ><button type="button" class="btn btn-outline-warning mb-1"  value={"corporate"} onClick={Subs}>CORPORATE</button></a>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Subscribed Users</h6>
                </div>
