...
function Admin(){
  ...
  useEffect(()=>{
    axios.get("http://16.171.172.126:3306/listtransaction").then(res=>setProducts(res.data));
},[product]);
...
async function Subs(e){
 ...
 console.log(e.target.value)
  ...
  const response = await fetch("http://16.171.172.126:3306/liststatus",config);
  ...
  setProducts2(data1)
    ...
    navigate('/livesessions1',{state:data1})
  }
...
<div class="card-body" >
                  ...
                  <a ><button type="button" class="btn btn-outline-primary mb-1" value={"live"}  onClick={Subs}>Live Sessions</button></a> &nbsp; 
                   <a ><button type="button" class="btn btn-outline-primary mb-1" value={"room3"}  onClick={Subs}>Room3</button></a> &nbsp; 
                    <a ><button type="button" class="btn btn-outline-primary mb-1" value={"corprate"}  onClick={Subs}>Corporate Users</button></a>
