...
function Subs(e) {
  ...
  console.log(data);
  axios.post("http://16.171.172.126:3306/subcatelist", data).then(
...
function handelDemo6(e) {
 ...
 function Saveproduct(e) {
     ...
     axios.post("http://16.171.172.126:3306/addcontent", formData, config).then(
         res => console.log(res)
                  ...
                  <div class="form-group">
                    ...
                    <option>Room1</option>
                     <option>Room2</option>
                      ...
                      <input type="" class="form-control" id="exampleInputTitle" aria-describedby="planTitle" placeholder="Enter Title" style={{height: "calc(1.5em + 0.75rem + 1px)!important;"}} onChange={handelDemo1}/>
                      </div>
                      
                      <div class="form-group">
                      <label for="exampleInputSubDescription">Description</label>
                      <input type="" class="form-control" id="exampleInputDescription" aria-describedby="planDescription" placeholder="Enter Description" style={{height: "calc(1.5em + 3rem + 1px)!important;"}} onChange={handelDemo2}/>
                      </div>
                    
                      <div class="form-group ">
                      <label for="exampleInputVideo">Video Link</label>
                      <input type="" class="form-control" id="exampleInputVideo" aria-describedby="planVideo" placeholder="Enter Video Link" style={{height: "calc(1.5em + 0.75rem + 1px)!important;"}} onChange={handelDemo6}/>
                      </div>
