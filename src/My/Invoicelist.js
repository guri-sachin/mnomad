...
function Admin() {
    ...
    useEffect(() => {
        axios.get("http://16.171.153.71:3306/listinvoice").then(res => setProducts(res.data));
    }, [product]);
    ...
    function Show3(e){
      ...
      console.log(e.target.name)
        ...
        axios.post(`http://16.171.153.71:3306/updateinvoice/${id}`,data).then(
          res=> console.log(res))
          console.log(id);
        console.log(data);
        Swal.fire({
  ...
  const response = await fetch("http://16.171.153.71:3306/listinvoiceon",config);
