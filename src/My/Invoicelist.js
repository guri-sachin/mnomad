...
function Admin() {
    ...
    useEffect(() => {
        axios.get("http://16.171.172.126:3306/listinvoice").then(res => setProducts(res.data));
    }, [product]);
    ...
    function Show3(e){
      ...
      console.log(e.target.name)
        var data= {"status":e.target.name};
      
        axios.post(`http://16.171.172.126:3306/updateinvoice/${id}`,data).then(
          res=> console.log(res))
          console.log(id);
        console.log(data);
        Swal.fire({
  ...
  const response = await fetch("http://16.171.172.126:3306/listinvoiceon",config);
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid" id="container-wrapper">
                            ...
                            {/* <div class="card-body" align="right">
                                ...
                                <a href="paidinvoice.html"><button type="button" class="btn btn-outline-primary mb-1">PAID INVOICE</button></a>
                                ...
                                <div class="col-lg-12 mb-4">
                                    ...
                                    <div class="card">
                                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                            <h6 class="m-0 font-weight-bold text-primary">Corporate Invoice</h6>
                                        </div>
                                                    ...
                                                    {product.map((item, index) => {
                                                        return (
                                                            <tr key={index}>
                                                                ...
                                                                <td>{item.price*item.member}</td>
                                                                <td>{item.email}</td>
                                                                <td>{item.date}</td>
                                                                <td>{item.Edate}</td>
                                                               
                                                                <td><div class="dropdown">
  <button class="btn btn-outline-primary mb-1 dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  >
  {item.status}
  </button>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
 
  <a  name={"Paid"} onClick={Show3}  id={item.id}   class="dropdown-item">Paid</a>
    <a  name={"Pending"} onClick={Show3} id={item.id}  class="dropdown-item">Pending</a>
                                                                ...
                                                                <td>      <button type="button" class="btn btn-outline-primary mb-1"  id={item.id}  onClick={Invoice}>VIEW INVOICE</button></td>
                                                            </tr>
                                                        );
                                                    })}
