...
import Copuser from './Corprate/copuser';
import Thank from './Corprate/Thank';
import Copdash from './Corprate/Copdash';
import Clog from './Corprate/Clog';
import Coplist from './Corprate/Coplist';
import Copedit from './Corprate/Copedit';
import Mdyv from './My/Mdyv';
import Cdyv from './Corprate/Cdyv';
import Csign from './Corprate/Csign';
import Cdetails from './Corprate/Cdetails';
 ...
 <div>
     ...
     <Route exact path="/Reported" element={<Reported/>}></Route>
           ...
           <Route exact path="/Dyv/:email" element={<Dyv />}></Route>
             ...
             <Route exact path="/Copuser" element={<Copuser/>}></Route>
             <Route exact path="/Thank" element={<Thank/>}></Route>   
             <Route exact path="/Copdash" element={<Copdash/>}></Route>  
             <Route exact path="/Coplist" element={<Coplist/>}></Route>  
             <Route exact path="/Copedit" element={<Copedit/>}></Route>  
             <Route exact path="/Clog" element={<Clog/>}></Route> 
             <Route exact path="/Cdyv/:email" element={<Cdyv/>}></Route>
             <Route exact path="/Mdyv/:email" element={<Mdyv/>}></Route>
             <Route exact path="/" element={<Csign/>}></Route>
             <Route exact path="/Cdetails" element={<Cdetails/>}></Route>
