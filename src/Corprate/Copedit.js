...
function Admin() {
    ...
    useEffect(() => {
        ...
        setPassword(location.state[0].password)
        setName(location.state[0].fname)



    }, []);
    function Saveproduct(e) {
        var data = {"id":id, "email": email, "password": password,"fname":name};
        console.log(data);

        axios.post("http://16.171.172.126:3306/memupdte", data).then(
            res => console.log(res)
                  ...
                  Activity Log
                        ...
                        <div class="container-fluid" id="container-wrapper">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Add Subscriptions</h1>
                                <ol class="breadcrumb">
                                        ...
                                        <div class="card-body">
                                            <form onSubmit={(event) => event.preventDefault()}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="plan" class="form-control" id="exampleInputPlan" aria-describedby="planlHelp" placeholder="Enter Email" onChange={handelDemo2} value={email} />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="plan" class="form-control" id="exampleInputPlan" aria-describedby="planlHelp" placeholder="Enter Fullname" onChange={handelDemo1} value={name} />

                                                </div>

                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Temporary Password</label>
                                                    <input type="" class="form-control" id="exampleInputPrice" aria-describedby="pricelHelp" placeholder="Enter Password" onChange={handelDemo3} value={password}/>
