...
function Admin(){
  ...
  function Saveproduct(e) {
    var data = {"email":email,"password":password,"user":user};
    console.log(data);
    
    axios.post("http://16.171.172.126:3306/adduserm",data).then(
        res=> console.log(res)
...
useEffect(()=>{
// var email1 = (sessionStorage.getItem("data1"))
let data = { "email": sessionStorage.getItem("data1") };
let email =  data.email.replace(/"/g, '');
// console.log(email1)
  // var data = { "email": email1}

  axios.post("http://16.171.172.126:3306/listmem", { email: email }).then(
    res =>
    setProducts(res.data)


  )
  // axios.get("http://16.170.233.21:3306/listcorpratein").then(res=>setProducts(res.data));
},[product]);
// useEffect(()=>{
//     axios.get("http://16.171.172.126:3306/listmem").then(res=>setProducts(res.data));
// },[product]);
...
function Piya(e){
    ...
    axios.get(`http://16.171.172.126:3306/memdelete/${id}`).then(
  ...
  function onEdit(e){
    const id = e.target.id;
    axios.get(`http://16.171.172.126:3306/memedit/${id}`).then(
        res =>{
       var diojk =res.data 
      navigate('/Copedit', { state: diojk})
...
<div class="card-body"  align="right">
                  ...
                  <a href="Copdash"><button type="button" class="btn btn-outline-primary mb-1">ADD</button></a>
