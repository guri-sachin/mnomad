...
// console.log(email1)
  ...
  axios.post("http://16.171.153.71:3306/listmem", { email: email }).then(
    res =>
...
// useEffect(()=>{
//     axios.get("http://16.171.153.71:3306/listmem").then(res=>setProducts(res.data));
// },[product]);
...
function Piya(e){
    ...
    axios.get(`http://16.171.153.71:3306/memdelete/${id}`).then(
  ...
  function onEdit(e){
    const id = e.target.id;
    axios.get(`http://16.171.153.71:3306/memedit/${id}`).then(
        res =>{
       var diojk =res.data 
