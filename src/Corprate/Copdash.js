...
function Admin(){
  ...
  useEffect(()=>{
    ...
    setUser(sessionStorage.getItem("data1"))
    console.log(user)
    var data = { "email": sessionStorage.getItem("data1")}
console.log(data)
    axios.post("http://16.171.172.126:3306/listgetcop", data).then(
      res =>
      setProduct(res.data)
  
      )

      axios.post("http://16.171.172.126:3306/copmemlise", data).then(
        res =>
 ...
 console.log(product1.length)
  function Saveproduct(e) {
    ...
    if(mem >= meml ){
      ...
      axios.post("http://16.171.172.126:3306/copmambermail",data).then(
        res=> console.log(res)
