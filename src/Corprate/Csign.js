...
const clientId ="254162278597-s668vcl9ith83ub967tutvv9m8n9jrcv.apps.googleusercontent.com";
   useEffect(() =>{
    function start(){
      gapi.client.init({
        clientId:clientId,
...
const onSuccess = (res) =>{
    ...
    navigate('/Cdetails',{ state: res.profileObj})
   }
   const onFailure = (res) =>{
...
const navigate = useNavigate();
  ...
  //     axios.post("http://16.171.153.71:3306/addcorpratef",data).then(
  //         res=> console.log(res)
  ...
  function Saveproduct(e) {
    ...
    axios.post("http://16.171.153.71:3306/copaddapilk", formData, config).then(
        res => console.log(res)
